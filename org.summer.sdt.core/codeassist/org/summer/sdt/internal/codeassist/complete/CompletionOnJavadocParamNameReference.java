...
public class CompletionOnJavadocParamNameReference extends JavadocSingleNameReference implements CompletionOnJavadoc {
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.internal.compiler.ast.AllocationExpression#printExpression(int, java.lang.StringBuffer)
	 */
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.internal.compiler.ast.SingleNameReference#reportError(org.summer.sdt.internal.compiler.lookup.BlockScope)
	 */
