	...
	private List getClasspath() throws IllegalStateException {
		...
		try {
			if ((this.bits & CompilationUnitResolver.INCLUDE_RUNNING_VM_BOOTCLASSPATH) != 0) {
				org.summer.sdt.internal.compiler.util.Util.collectRunningVMBootclasspath(allClasspaths);
			}
		...
		switch(this.astKind) {
				...
				if (this.rawSource == null) {
					if (this.typeRoot != null) {
						...
						if (this.typeRoot instanceof ICompilationUnit) {
							org.summer.sdt.internal.compiler.env.ICompilationUnit sourceUnit = (org.summer.sdt.internal.compiler.env.ICompilationUnit) this.typeRoot;
			...
			case K_COMPILATION_UNIT :
				...
				try {
					...
					org.summer.sdt.internal.compiler.env.ICompilationUnit sourceUnit = null;
	...
	private ASTNode internalCreateASTForKind() {
		...
		switch(this.astKind) {
			case K_STATEMENTS :
				...
				org.summer.sdt.internal.compiler.ast.Statement[] statements = constructorDeclaration.statements;
				if (statements != null) {
				...
				return block;
			case K_EXPRESSION :
				org.summer.sdt.internal.compiler.ast.Expression expression = codeSnippetParsingUtil.parseExpression(this.rawSource, this.sourceOffset, this.sourceLength, this.compilerOptions, true);
			...
			case K_CLASS_BODY_DECLARATIONS :
				final org.summer.sdt.internal.compiler.ast.ASTNode[] nodes =
