...
class BindingResolver {
	 ...
	 */
	org.summer.sdt.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode) {
		return null;
	}
	 ...
	 */
	IMethodBinding getMethodBinding(org.summer.sdt.internal.compiler.lookup.MethodBinding methodBinding) {
		return null;
	}
	 ...
	 */
	IPackageBinding getPackageBinding(org.summer.sdt.internal.compiler.lookup.PackageBinding packageBinding) {
		return null;
	}
	 ...
	 */
	ITypeBinding getTypeBinding(org.summer.sdt.internal.compiler.lookup.TypeBinding referenceBinding) {
		return null;
	}
	 ...
	 */
	IVariableBinding getVariableBinding(org.summer.sdt.internal.compiler.lookup.VariableBinding binding) {
		return null;
	}
	 ...
	 */
	IAnnotationBinding getAnnotationInstance(org.summer.sdt.internal.compiler.lookup.AnnotationBinding instance) {
		return null;
	}
	 ...
	 */
	void store(ASTNode newNode, org.summer.sdt.internal.compiler.ast.ASTNode oldASTNode) {
		// default implementation: do nothing
	}
