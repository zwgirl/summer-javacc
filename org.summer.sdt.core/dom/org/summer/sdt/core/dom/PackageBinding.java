...
class PackageBinding implements IPackageBinding {
	...
	private org.summer.sdt.internal.compiler.lookup.PackageBinding binding;
	private String name;
	private BindingResolver resolver;
	private String[] components;

	PackageBinding(org.summer.sdt.internal.compiler.lookup.PackageBinding binding, BindingResolver resolver) {
				...
				switch(fragType) {
					...
					case IPackageFragmentRoot.K_BINARY:
						...
						if (answer != null && answer.isBinaryType()) {
							...
							org.summer.sdt.internal.compiler.lookup.AnnotationBinding[] binaryInstances =
								BinaryTypeBinding.createAnnotations(binaryAnnotations, this.binding.environment, missingTypeNames);
							org.summer.sdt.internal.compiler.lookup.AnnotationBinding[] allInstances =
								org.summer.sdt.internal.compiler.lookup.AnnotationBinding.addStandardAnnotations(binaryInstances, type.getTagBits(), this.binding.environment);
	...
	public boolean isEqualTo(IBinding other) {
		...
		org.summer.sdt.internal.compiler.lookup.PackageBinding packageBinding2 = ((PackageBinding) other).binding;
