...
class RecoveredTypeBinding implements ITypeBinding {
	...
	private org.summer.sdt.internal.compiler.lookup.TypeBinding binding;
	...
	RecoveredTypeBinding(BindingResolver resolver, org.summer.sdt.internal.compiler.lookup.TypeBinding typeBinding) {
		this.resolver = resolver;
