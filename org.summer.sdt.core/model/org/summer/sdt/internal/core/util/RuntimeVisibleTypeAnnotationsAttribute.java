...
import org.summer.sdt.core.util.IRuntimeVisibleTypeAnnotationsAttribute;
...
public class RuntimeVisibleTypeAnnotationsAttribute
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.core.util.IRuntimeVisibleTypeAnnotationsAttribute.getExtendedAnnotations()
	 */
	public IExtendedAnnotation[] getExtendedAnnotations() {
		return this.extendedAnnotations;
	}
	/* (non-Javadoc)
	 * @see org.summer.sdt.core.util.IRuntimeVisibleTypeAnnotationsAttribute.getExtendedAnnotationsNumber()
	 */
