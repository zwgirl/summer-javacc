...
import org.summer.sdt.core.util.IAnnotation;
...
public class ParameterAnnotation extends ClassFileStruct implements IParameterAnnotation {
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.core.util.IParameterAnnotation#getAnnotations()
	 */
	public IAnnotation[] getAnnotations() {
		return this.annotations;
	}
	/* (non-Javadoc)
	 * @see org.summer.sdt.core.util.IParameterAnnotation#getAnnotationsNumber()
	 */
