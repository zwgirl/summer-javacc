 ...
 *
 * @see org.summer.sdt.internal.core.util.ILRUCacheable
 */
...
public class LRUCache implements Cloneable {
	...
	protected String toStringContents() {
		...
		for (int i = 0; i < length; i++) {
			...
			unsortedKeys[i] = key;
			unsortedToStrings[i] =
				(key instanceof org.summer.sdt.internal.core.JavaElement) ?
					((org.summer.sdt.internal.core.JavaElement)key).getElementName() :
					key.toString();
		}
