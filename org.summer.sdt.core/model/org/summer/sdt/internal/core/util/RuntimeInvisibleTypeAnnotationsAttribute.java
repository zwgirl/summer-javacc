...
import org.summer.sdt.core.util.IExtendedAnnotation;
import org.summer.sdt.core.util.IRuntimeInvisibleTypeAnnotationsAttribute;
...
public class RuntimeInvisibleTypeAnnotationsAttribute
	...
	/* (non-Javadoc)
	 * @see org.summer.sdt.core.util.IRuntimeInvisibleTypeAnnotationsAttribute.getExtendedAnnotations()
	 */
	public IExtendedAnnotation[] getExtendedAnnotations() {
		return this.extendedAnnotations;
	}
	/* (non-Javadoc)
	 * @see org.summer.sdt.core.util.IRuntimeInvisibleTypeAnnotationsAttribute.getExtendedAnnotationsNumber()
	 */
