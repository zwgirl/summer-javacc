...
import org.summer.sdt.core.eval.IGlobalVariable;
...
import org.summer.sdt.internal.core.builder.NameEnvironment;
import org.summer.sdt.internal.core.builder.ProblemFactory;
import org.summer.sdt.internal.eval.EvaluationContext;
import org.summer.sdt.internal.eval.GlobalVariable;
import org.summer.sdt.internal.eval.IRequestor;
import org.summer.sdt.internal.eval.InstallException;
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#allVariables()
 */
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#codeComplete(String, int, ICompletionRequestor)
 * @deprecated
 */
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#codeComplete(String, int, ICompletionRequestor, WorkingCopyOwner)
 * @deprecated
 */
public void codeComplete(String codeSnippet, int position, ICompletionRequestor requestor, WorkingCopyOwner owner) throws JavaModelException {
	...
	codeComplete(codeSnippet, position, new org.summer.sdt.internal.codeassist.CompletionRequestorWrapper(requestor), owner);
}
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor)
 */
public void codeComplete(String codeSnippet, int position, CompletionRequestor requestor) throws JavaModelException {
	codeComplete(codeSnippet, position, requestor, DefaultWorkingCopyOwner.PRIMARY);
}
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, IProgressMonitor)
 */
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, WorkingCopyOwner)
 */
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, WorkingCopyOwner, IProgressMonitor)
 */
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#codeSelect(String, int, int)
 */
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#codeSelect(String, int, int, WorkingCopyOwner)
 */
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#deleteVariable(IGlobalVariable)
 */
...
public void evaluateCodeSnippet(
	...
	IProgressMonitor progressMonitor) throws org.summer.sdt.core.JavaModelException {
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#getImports()
 */
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#getPackageName()
 */
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#getProject()
 */
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#newVariable(String, String, String)
 */
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#setImports(String[])
 */
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext#setPackageName(String)
 */
 ...
 */
public void codeComplete(String codeSnippet, int position, final org.summer.sdt.core.ICodeCompletionRequestor requestor) throws JavaModelException {
