...
public class CopyResourceElementsOperation extends MultiOperation implements SuffixConstants {
	...
	private void processCompilationUnitResource(ICompilationUnit source, PackageFragment dest) throws JavaModelException {
		...
		org.summer.sdt.internal.core.CompilationUnit destCU = new org.summer.sdt.internal.core.CompilationUnit(dest, destName, DefaultWorkingCopyOwner.PRIMARY);
	...
	private void updatePackageStatement(CompilationUnit astCU, String[] pkgName, ASTRewrite rewriter, ICompilationUnit cu) throws JavaModelException {
		...
		if (defaultPackage) {
			...
			org.summer.sdt.core.dom.PackageDeclaration pkg = astCU.getPackage();
			if (pkg != null) {
	...
	protected void verify(IJavaElement element) throws JavaModelException {
		...
		if (elementType == IJavaElement.COMPILATION_UNIT) {
			org.summer.sdt.internal.core.CompilationUnit compilationUnit = (org.summer.sdt.internal.core.CompilationUnit) element;
