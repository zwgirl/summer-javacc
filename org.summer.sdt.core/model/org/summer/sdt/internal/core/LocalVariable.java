...
public class LocalVariable extends SourceRefElement implements ILocalVariable {
	...
	public LocalVariable(
			...
			int nameEnd,
			String typeSignature,
			org.summer.sdt.internal.compiler.ast.Annotation[] astAnnotations,
			int flags,
			boolean isParameter) {
	...
	public LocalVariable(
			...
			int flags,
			boolean isParameter,
		org.summer.sdt.internal.compiler.ast.Annotation[][] astAnnotationsOnDimensions) {
	...
	private IAnnotation[] getAnnotations(org.summer.sdt.internal.compiler.ast.Annotation[] astAnnotations) {
		int length;
	...
	private IAnnotation getAnnotation(final org.summer.sdt.internal.compiler.ast.Annotation annotation, JavaElement parentElement) {
		...
		org.summer.sdt.internal.compiler.ast.MemberValuePair[] astMemberValuePairs = annotation.memberValuePairs();
		int length;
		IMemberValuePair[] memberValuePairs;
		if (astMemberValuePairs == null || (length = astMemberValuePairs.length) == 0) {
			...
			for (int i = 0; i < length; i++) {
				org.summer.sdt.internal.compiler.ast.MemberValuePair astMemberValuePair = astMemberValuePairs[i];
	...
	private Object getAnnotationMemberValue(MemberValuePair memberValuePair, Expression expression, JavaElement parentElement) {
		if (expression instanceof NullLiteral) {
			...
			return getAnnotation((org.summer.sdt.internal.compiler.ast.Annotation) expression, parentElement);
