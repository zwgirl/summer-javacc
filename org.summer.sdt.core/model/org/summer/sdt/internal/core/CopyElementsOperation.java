		...
		switch (element.getElementType()) {
			...
			case IJavaElement.TYPE :
				if (isRenamingMainType(element, dest)) {
					...
					String lineSeparator = org.summer.sdt.internal.core.util.Util.getLineSeparator(source, element.getJavaProject());
			...
			case IJavaElement.FIELD :
				...
				lineSeparator = org.summer.sdt.internal.core.util.Util.getLineSeparator(source, element.getJavaProject());
...
protected boolean isRenamingMainType(IJavaElement element, IJavaElement dest) throws JavaModelException {
	if ((isRename() || getNewNameFor(element) != null)
		...
		typeName = org.summer.sdt.internal.core.util.Util.getNameWithoutJavaLikeExtension(typeName);
