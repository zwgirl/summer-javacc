 ...
 *
 * @see org.summer.sdt.internal.compiler.IDocumentElementRequestor#acceptLineSeparatorPositions(int[])
 */
...
/**
 * @see org.summer.sdt.internal.compiler.IDocumentElementRequestor#enterClass(int, int[], int, int, int, char[], int, int, char[], int, int, char[][], int[], int[], int)
 */
 ...
 *
 * @see org.summer.sdt.internal.compiler.IDocumentElementRequestor#exitCompilationUnit(int)
 */
