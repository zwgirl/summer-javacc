...
import org.summer.sdt.internal.core.util.ClassFileReader;
import org.summer.sdt.internal.core.util.Disassembler;
import org.summer.sdt.internal.core.util.PublicScanner;
...
public class ToolFactory {
	 ...
	 *
	 * @return a classfile bytecode disassembler
	 * @see org.summer.sdt.core.util.IClassFileDisassembler
	 * @deprecated Use {@link #createDefaultClassFileBytesDisassembler()} instead
	 */
	public static org.summer.sdt.core.util.IClassFileDisassembler createDefaultClassFileDisassembler(){
		class DeprecatedDisassembler extends Disassembler implements org.summer.sdt.core.util.IClassFileDisassembler {
		...
		if (root != null){
			try {
				if (root instanceof JarPackageFragmentRoot) {
					...
					String entryName = org.summer.sdt.internal.core.util.Util.concatWith(packageFragment.names, classFileName, '/');
	...
	public static ICodeFormatter createDefaultCodeFormatter(Map options){
		if (options == null) options = JavaCore.getOptions();
		return new org.summer.sdt.internal.formatter.old.CodeFormatter(options);
	}
	 ...
	 * considered as valid line separators.
  	 * @return a scanner
	 * @see org.summer.sdt.core.compiler.IScanner
