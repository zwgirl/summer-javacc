 ...
 *******************************************************************************/
package org.summer.sdt.internal.formatter.old;
...
public class CodeFormatter implements TerminalTokens, org.summer.sdt.core.ICodeFormatter {
	...
	public String format(String string, int indentLevel, int[] positions, String lineSeparator) {
		...
		TextEdit textEdit = defaultCodeFormatter.format(org.summer.sdt.core.formatter.CodeFormatter.K_UNKNOWN, string, 0, string.length(), indentLevel, lineSeparator);
