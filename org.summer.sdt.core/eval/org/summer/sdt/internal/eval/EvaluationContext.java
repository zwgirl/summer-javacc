...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext
 */
...
public EvaluationContext() {
	...
	this.lineSeparator = org.summer.sdt.internal.compiler.util.Util.LINE_SEPARATOR; // default value
}
/**
...
/**
 * @see org.summer.sdt.core.eval.IEvaluationContext
 * @exception org.summer.sdt.internal.eval.InstallException if the code snippet class files could not be deployed.
 */
...
writer.write(org.summer.sdt.internal.eval.EvaluationContext.getCodeSnippetSource());
writer.close();
org.summer.sdt.internal.compiler.batch.Main.compile(
...
byte[] bytes = org.summer.sdt.internal.core.Util.readContentsAsBytes(reader);
reader.close();
...
public static String getCodeSnippetSource() {
	return
		"package org.summer.sdt.internal.eval.target;\n" + //$NON-NLS-1$
		"\n" + //$NON-NLS-1$
		"/*\n" + //$NON-NLS-1$
...
/**
 * Return the binary for the root code snippet class (i.e. org.summer.sdt.internal.eval.target.CodeSnippet).
 */
 ...
 *
 *  @param environment org.summer.sdt.internal.core.SearchableEnvironment
 *      used to resolve type/package references and search for types/packages
 *      based on partial names.
 *
